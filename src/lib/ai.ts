...
export async function checkRateLimit(supabase: any, userId: string, type: string): Promise<boolean> {
  ...
  const limits: Record<string, Record<string, number>> = {
    free: { generate: 10, rewrite: 20, suggest: 50, seo_analyze: 5, generate_image: 5, generate_header_image: 3, suggest_tags: 20, design: 3, field_assist: 20, analyze: 1, translate: 5 },
