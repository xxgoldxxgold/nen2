...
export async function checkRateLimit(supabase: any, userId: string, type: string): Promise<boolean> {
  ...
  const limits: Record<string, Record<string, number>> = {
    free: { generate: 9999, rewrite: 9999, suggest: 9999, seo_analyze: 9999, generate_image: 9999, generate_header_image: 9999, suggest_tags: 9999, design: 9999, field_assist: 9999, analyze: 9999, translate: 9999 },
    pro: { generate: 100, rewrite: 200, suggest: 500, seo_analyze: 9999, generate_image: 50, generate_header_image: 20, suggest_tags: 200, design: 9999, field_assist: 200, analyze: 10, translate: 50 },
    business: { generate: 9999, rewrite: 9999, suggest: 9999, seo_analyze: 9999, generate_image: 200, generate_header_image: 100, suggest_tags: 9999, design: 9999, field_assist: 9999, analyze: 9999, translate: 9999 },
  }
