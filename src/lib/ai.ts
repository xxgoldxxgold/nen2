...
export async function checkRateLimit(supabase: any, userId: string, type: string): Promise<boolean> {
  ...
  const limits: Record<string, Record<string, number>> = {
    free: { generate: 10, rewrite: 20, suggest: 50, seo_analyze: 5, generate_image: 5, suggest_tags: 20, field_assist: 20, analyze: 1, translate: 5 },
    pro: { generate: 100, rewrite: 200, suggest: 500, seo_analyze: 9999, generate_image: 50, suggest_tags: 200, field_assist: 200, analyze: 10, translate: 50 },
    business: { generate: 9999, rewrite: 9999, suggest: 9999, seo_analyze: 9999, generate_image: 200, suggest_tags: 9999, field_assist: 9999, analyze: 9999, translate: 9999 },
  }
